...
require 'spree_on_sale/version'

Gem::Specification.new do |spec|
  spec.platform    = Gem::Platform::RUBY
  spec.name        = 'spree_on_sale'
  spec.version     = SpreeOnSale::VERSION
  spec.authors     = ['David Freerksen']
  spec.homepage    = 'http://github.com/groundctrl/spree_on_sale'
  spec.summary     = 'Put products on sale without changing the regular price.'
